...
set CONNECTION_STRING=Host=172.27.76.33;Port=30432;Database=jk_offer
set CLI_PROJECT=../../../Tools/JK.Migrations.Cli
set DB_PROJECT=JK.Offer.Database.csproj
set ASSEMBLY_PATH=bin/Local-Dev/net9.0/JK.Offer.Database.dll
